                ...
                <div className="nav">
                    ...
                    >
                        <nav className="sb-sidenav-menu-nested nav">
                            ...
                            {hasAnyPermission(['posts.index']) && (
                                <Link className={activeRoute[2] === 'posts' ? 'nav-link active-sidebar' : 'nav-link'} to="/admin/posts">
                                    Posts
                                </Link>
                            )}

                            {hasAnyPermission(['pages.index']) && (
                                <Link className={activeRoute[2] === 'pages' ? 'nav-link active-sidebar' : 'nav-link'} to="/admin/pages">
                                    Pages
                                </Link>
                            )}
                    ...
                    {(hasAnyPermission(['photos.index']) || hasAnyPermission(['sliders.index'])) && (
                        <>
                            <div className="sb-sidenav-menu-heading">MEDIA MANAGEMENT</div>
                            <a
                                className={
                                    'nav-link collapsed ' +
                                    (activeRoute[2] === 'photos' ? ' active-sidebar' : activeRoute[2] === 'sliders' ? ' active-sidebar' : '')
                                }
                                href="#"
                                data-bs-toggle="collapse"
                    ...
                    <div
                        className={'collapse ' + (activeRoute[2] === 'photos' ? ' show' : activeRoute[2] === 'sliders' ? ' show' : '')}
                        id="collapseMedias"
                        aria-labelledby="headingOne"
                        data-bs-parent="#sidenavAccordion"
                    >
                        <nav className="sb-sidenav-menu-nested nav">
                            {hasAnyPermission(['photos.index']) && (
                                <Link className={activeRoute[2] === 'photos' ? 'nav-link active-sidebar' : 'nav-link'} to="/admin/photos">
                                    Photos
                                </Link>
                            )}

                            {hasAnyPermission(['sliders.index']) && (
                                <Link className={activeRoute[2] === 'sliders' ? 'nav-link active-sidebar' : 'nav-link'} to="/admin/sliders">
                                    Sliders
                                </Link>
                            )}
                        </nav>
                    ...
                    {hasAnyPermission(['aparaturs.index']) && (
                        <>
                            ...
                            <Link className={activeRoute[2] === 'aparaturs' ? 'nav-link active-sidebar' : 'nav-link'} to="/admin/aparaturs">
                                <div className="sb-nav-link-icon">
